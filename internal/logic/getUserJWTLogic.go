...
type GetUserJWTLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewGetUserJWTLogic(ctx context.Context, svcCtx *svc.ServiceContext) GetUserJWTLogic {
	return GetUserJWTLogic{
...
func createTemporaryAccount() *model.Users {
...
func (l *GetUserJWTLogic) GetUserJWT(req types.JwtReq, r *http.Request, w http.ResponseWriter) (*types.JwtRsp, error) {
	...
	if err != nil || cookie == nil || cookie.Value == "" {
		...
		_, errInsert := l.svcCtx.UsersModel.Insert(u)
		if errInsert != nil {
